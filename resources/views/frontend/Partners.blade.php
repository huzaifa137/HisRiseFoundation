            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="p-4 shadow-sm rounded border border-2" style="border-color: #2db7c9!important;">
                    ...
                    <p class="mb-4" style="text-align: justify;">
                        ...
                        your organization to align its corporate social responsibility (CSR) goals or mission with
                        on-the-ground programs that deliver measurable change in vulnerable communities.
                    </p>
                    <p class="mb-4" style="text-align: justify;">
                    ...
                    <ul class="list-group list-group-flush mb-4">
                        <li class="list-group-item d-flex align-items-center border-0 ps-0"><i
                                class="fa fa-handshake text-primary me-3"></i>Shared Impact: Direct involvement in
                            projects aligned with your strategic objectives.</li>
                        <li class="list-group-item d-flex align-items-center border-0 ps-0"><i
                                class="fa fa-chart-line text-primary me-3"></i>Visibility & Reach: Exposure to our
                            extensive community network and outreach platforms.</li>
                        <li class="list-group-item d-flex align-items-center border-0 ps-0"><i
                                class="fa fa-award text-primary me-3"></i>CSR Alignment: Demonstrate corporate
                            responsibility and enhance brand reputation.</li>
                        <li class="list-group-item d-flex align-items-center border-0 ps-0"><i
                                class="fa fa-bullseye text-primary me-3"></i>Measurable Results: Receive detailed
                            reports on the impact of your investment.</li>
                    </ul>
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="bg-light p-5 shadow rounded border border-3 border-primary">
                    ...
                    <form id="partnerForm">
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="text" class="form-control border-0 py-3" name="organization"
                                    placeholder="Organization/Company Name" required>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control border-0 py-3" name="contact_name"
                            ...
                            <div class="col-12">
                                <select class="form-select border-0 py-3" name="organization_type" required>
                            ...
                            <div class="col-12">
                                <select class="form-select border-0 py-3" name="interest_area" required>
                            ...
                            <div class="col-12">
                                <textarea class="form-control border-0" name="message" rows="6"
                                    placeholder="Briefly describe your organization and partnership vision."
                                    required></textarea>
                            </div>
