...
<!-- Contact Start -->
<div class="container-fluid contact py-5 earth-circles-bg" style="background: #f9fafc;">
    <div class="container py-5"
        ...
        <div class="section-bg my-3" style="border-radius: 10%">
            <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">

                <p class="fs-5 text-uppercase text-primary pt-4">Get In Touch</p>
            ...
            <div class="row g-4 wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="col-12">
                    <textarea class="w-100 form-control bg-transparent p-3" rows="6" cols="10"
                        placeholder="Your Message" style="border: 1px solid #2db7c9; border-radius: 8px;"></textarea>
                </div>
