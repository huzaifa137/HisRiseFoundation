    <div class="bg-dark border-right" id="sidebar-wrapper" style="min-width: 250px;">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('admin.settings') }}"
                class="list-group-item list-group-item-action bg-dark text-white {{ request()->routeIs('admin.settings') ? 'active' : '' }}">
                <i class="fas fa-cog me-2"></i> Settings
            </a>

            <a href="{{ route('admin.messages') }}"
                class="list-group-item list-group-item-action bg-dark text-white {{ request()->routeIs('admin.messages') ? 'active' : '' }}">
